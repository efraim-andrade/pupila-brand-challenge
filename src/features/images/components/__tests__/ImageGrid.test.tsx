...
import type { Group, Image, Tag, ViewMode } from '@/types';
...
describe('ImageGrid', () => {
  describe('empty state', () => {
    it('renders empty state when no images', () => {
      ...
      expect(
        screen.getByText('Try adjusting your filters or add a new image')
      ).toBeInTheDocument();
    });
  });
  ...
  describe('list view', () => {
    it('renders image rows in list layout', () => {
      render(
        <ImageGrid {...defaultProps} images={[makeImage()]} viewMode="list" />
      );
