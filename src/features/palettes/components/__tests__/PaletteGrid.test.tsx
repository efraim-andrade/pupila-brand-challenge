...
describe('PaletteGrid', () => {
  describe('empty state', () => {
    it('renders empty state when no palettes', () => {
      ...
      expect(screen.getByText('Try adjusting your filters or create a new palette')).toBeInTheDocument()
    })
  })
  ...
  describe('list view', () => {
    it('renders palette rows in list layout', () => {
      render(<PaletteGrid {...defaultProps} palettes={[makePalette()]} viewMode="list" />)
      ...
      render(
        <PaletteGrid
          ...
          palettes={[
            makePalette({
              comments: [
                { id: 'c-1', text: 'Comment 1', createdAt: '2024-01-01T00:00:00.000Z', updatedAt: '2024-01-01T00:00:00.000Z' },
                { id: 'c-2', text: 'Comment 2', createdAt: '2024-01-01T00:00:00.000Z', updatedAt: '2024-01-01T00:00:00.000Z' },
              ],
            }),
          ]}
          viewMode="list"
