  ...
  return (
    <div className="flex flex-wrap items-center gap-3 border-b border-gray-200 bg-white px-6 py-4">
      ...
      <select
        ...
        className="rounded-lg border border-gray-200 bg-gray-50 py-2 pl-3 pr-8 text-sm text-gray-700 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"
      >
      ...
      <div className="ml-auto flex items-center gap-2">
        <span className="text-xs text-gray-400">
          {filteredCount === totalCount
            ? `${totalCount} palette${totalCount !== 1 ? 's' : ''}`
            : `${filteredCount} of ${totalCount} palettes`}
        </span>
