...
describe('Button', () => {
  ...
  describe('variant prop', () => {
    it('applies primary variant classes by default', () => {
      ...
      expect(screen.getByRole('button')).toHaveClass('bg-indigo-600', 'text-white')
    })
    ...
    it('applies secondary variant classes', () => {
      ...
      expect(screen.getByRole('button')).toHaveClass('border', 'border-gray-200', 'text-gray-600')
    })
  ...
  describe('size prop', () => {
    it('applies md size by default', () => {
      ...
      expect(screen.getByRole('button')).toHaveClass('rounded-lg', 'px-4', 'py-2', 'text-sm')
    })

    it('applies xs size classes', () => {
      render(<Button size="xs">Button</Button>)

      expect(screen.getByRole('button')).toHaveClass('rounded', 'px-2', 'py-1', 'text-xs')
    })

    it('applies sm size classes', () => {
      render(<Button size="sm">Button</Button>)

      expect(screen.getByRole('button')).toHaveClass('rounded-lg', 'px-2.5', 'py-1.5', 'text-sm')
    })
